  ...
  describe "POST #create" do
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved port as @port" do
        post :create, {:port => invalid_attributes}, valid_session
        expect(assigns(:port)).to be_a_new(Port)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested port" do
        port = Port.create! valid_attributes
        put :update, {:id => port.to_param, :port => new_attributes}, valid_session
        port.reload
    ...
    context "with invalid params" do
      it "assigns the port as @port" do
        port = Port.create! valid_attributes
        put :update, {:id => port.to_param, :port => invalid_attributes}, valid_session
        expect(assigns(:port)).to eq(port)
      end
